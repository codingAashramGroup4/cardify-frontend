...
import EyeLogo from "../../../assets/closeEyeIcon.svg";
const Page: React.FC = () => {
  ...
  return (
    <div>
      <div className="font-[sans-serif] bg-white text-[#333] flex items-center justify-center md:h-screen p-4">
                ...
                <div className="mt-10">
                  ...
                  <div className="relative flex items-center">
                    ...
                    {visible == "password" ? (
                      ...
                      <Image src={EyeLogo} alt="" width={18} height={18} onClick={passVisible} className="w-[18px] h-[18px] absolute right-2 cursor-pointer opacity-70"/>
                    )}
                  </div>
                </div>
