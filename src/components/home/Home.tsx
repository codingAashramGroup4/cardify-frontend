...
const accData = [
  {
    title: "What makes 'INFYCARDIFY' unique compared to other platforms ?",
    content:
      "Unlike traditional CARDIFY platforms, INFYCARDIFY leverages the power of Web3 technology to provide a decentralized and boundless experience. The platform also offers an immersive metaverse environment, where users can engage with CARDIFYs in a dynamic and interactive way.",
  },
  {
    title: "How can I participate as an artist in INFYCARDIFY ?",
    content:
      "Unlike traditional CARDIFY platforms, INFYCARDIFY leverages the power of Web3 technology to provide a decentralized and boundless experience. The platform also offers an immersive metaverse environment, where users can engage with CARDIFYs in a dynamic and interactive way.",
  },
  {
...
const Home = () => {
  return (
    <div className="bg-[#050C24]">
      <div className="relative mx-auto pt-6 flex flex-col items-center justify-center text-[#D2DADF] bg-[url('/image/gradient.svg')] bg-cover">
        ...
        <div className="flex w-full md:max-w-[1120px] flex-col gap-10 md:gap-20 px-5 xl:px-0 pt-20">
          {/* Home SECTION */}
          <div className=" z-10 flex flex-col gap-5 md:gap-0 items-center justify-center md:flex-row md:justify-between xl:pr-20">
